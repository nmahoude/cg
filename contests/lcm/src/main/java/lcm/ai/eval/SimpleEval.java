...
//    }
    ...
    myValues[VALUES.USED_MANA.ordinal()] = -0.1 * state.me.mana;
  ...
  private double evaluateHandCardEGaetan(Card card) {
    ...
    score += ((card.abilities & Abilities.CHARGE) != 0) ? 6 : 0;
  ...
  public static void comparator(SimpleEval first, SimpleEval second) {
