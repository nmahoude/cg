...
== GOLD 19/05
09h59 / : moins de poids pour le xpGain
09h46 /  : poids (enorme) sur le xpGain
09h35 / 21 : modification de la prise de samples
09h20 / 17: greedy à 8 dans les molecule
...
NO GOOD 02h52    : petit bonus si on fill les xp à 0 + essayer de faire ressembler le SAMPLE a celui d'Agade 
