...
public class GraphPane extends Pane {
  protected double stageScale = 1.0;
  ...
  private GameNode rootGameNode;

  public GlobalData globalData = new GlobalData();

  protected boolean controlIsDown = false;

  public void init(GameNode rootGameNode) throws Exception {
    this.rootGameNode = rootGameNode;
