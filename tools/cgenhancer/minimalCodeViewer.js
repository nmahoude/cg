...
// Mise à jour pour laisser une partie du code visible (date de génération)
...
(function()
{
    ...
    function handleBlocs()
    {
        ...
        if (cgSyncActive)
        {
            ...
            if (codeBloc.css('height') !== '100px')
                codeBloc.css('height',     '100px');
            if (consoleBloc.css('top') !== '100px')
                consoleBloc.css('top',     '100px');
