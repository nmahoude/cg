...
public class AGSolution {
  ...
  public static void crossover(AGSolution child, AGSolution parent1, AGSolution parent2) {
    child.resetSolution();
    for (int i=0;i<8;i++) {
  ...
  public static void mutate(AGSolution child, AGSolution parent) {
    ...
    for (int i=0;i<8;i++) {
      if (rand.fastRandInt(chancesOverToMutate) == 0) {
