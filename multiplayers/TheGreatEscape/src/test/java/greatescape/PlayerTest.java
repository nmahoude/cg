...
public class PlayerTest {
  ...
  public void horizontalToBlockProgression() throws Exception {
    ...
    List<PathItem> trajectory = new AStar(board, board.cells[8][3], GameState.getTargetFromId(1)).find();
    assertThat(trajectory.size(), is(9));

    board.addWall(14, 7, 3, WallOrientation.H);
    List<PathItem> trajectory2 = new AStar(board, board.cells[8][3], GameState.getTargetFromId(1)).find();
  ...
  public void hitWallTooEasily() throws Exception {
    ...
    List<PathItem> trajectory = new AStar(board, board.cells[0][2], GameState.getTargetFromId(0)).find();
  ...
  public void directDansLeMur() throws Exception {
    ...
    List<PathItem> trajectory = new AStar(board, board.cells[7][6], GameState.getTargetFromId(0)).find();
