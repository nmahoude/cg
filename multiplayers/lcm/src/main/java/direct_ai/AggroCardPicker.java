...
public class AggroCardPicker {
  ...
  public void pick(Agent agent, CardTriplet triplet) {
    ...
    for (int i=0;i<3;i++) {
      ...
      double faceValue = cardValue(card);
  ...
  private double cardValue(Card card) {
    double faceValue = Card.precalculatedFaceValue[card.instanceId];
